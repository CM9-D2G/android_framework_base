...
class TelephonyRegistry extends ITelephonyRegistry.Stub {
    ...
    private ConcurrentHashMap<String, DataStateNotification> mPreviousDataNotifications;
    ...
    TelephonyRegistry(Context context) {
        ...
        mPreviousDataNotifications = new ConcurrentHashMap<String, DataStateNotification>();
    }
