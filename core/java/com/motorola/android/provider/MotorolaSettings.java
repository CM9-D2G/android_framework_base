...
public final class MotorolaSettings {
    ...
    private static class NameValueCache {
        ...
        private static final String[] SELECT_VALUE = new String[] { MotorolaSettings.NameValueTable.VALUE };
    ...
    public synchronized static String getString(ContentResolver resolver, String name) {
        if (mNameValueCache == null) {
            mNameValueCache = new NameValueCache(MOT_PROP_SETTING_VERSION, CONTENT_URI);
        }
